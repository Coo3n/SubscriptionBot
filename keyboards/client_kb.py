...
but_sub_url_channel   = InlineKeyboardButton(text = "💥 ПОДПИСАТЬСЯ 💥", url = "https://t.me/ffldlldldkf")
but_check_sub_channel = InlineKeyboardButton(text = "👉 ПОДПИСАЛСЯ 👈", callback_data = "check_sub_to_channel")
